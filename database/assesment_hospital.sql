...
('3326','Appolonia','Streatfeild','PO Box 77011','astreatfeild7@jugem.jp','Oncologists','City Centre'),
('3527','Georgena','Harradence','11th Floor','gharradencef@yelp.com','general','University of Aberdeen'),
...
('4438','Killian','Pendell','Suite 41','kpendell8@shinystat.com','general','University of Aberdeen'),
('4449','Romola','Thurber','Room 1380','rthurberg@disqus.com','general','University of Aberdeen'),
('4516','Denny','Kohen','Apt 1449','dkohenc@bluehost.com','Oncologists','City Centre'),
...
('7697','Lottie','Deveral','12th Floor','ldeverale@wunderground.com','general','University of Aberdeen'),
...
('7842','Guillaume','Insley','5th Floor','ginsley6@blinklist.com','Oncologists','City Centre'),
...
('9116','Lars','Elwyn','Room 573','lelwyna@wikimedia.org','Oncologists','City Centre'),
...
('09652','Ibuprofen kids','Repair of prostate','Replace of R Trunk Tendon with Synth Sub  Perc Endo Approach'),
...
('30087241','Christopher','Cameron','AB15 6BN','53 Gairsay Court','01224 212121','30087241@nescol.ac.uk','NHS'),
('30087242','Dittod','Dom','AB15 8GF','Gallowgate','07477844988','ditto@gmail.com','NHS'),
...
('9018414','Daffy','Dale','ab24 5ub','The Green','01224 894321','deendale@abz.co.uk','NHS'),
('9GM3J9FK','Aindrea','Bleue','IV1 8HN','07831 Crest Line Way','382 440 0254','ableuep@youtube.com','NHS'),
('AFR2WRY7','Farah','Lanchbury','AB10 7TH','9 Birchwood Pass','648 320 5941','flanchbury0@hc360.com','NHS'),
...
('MMM4B1JV','Archer','Danilyak','KY12 5GD','38059 Eastwood Crossing','169 847 7396','adanilyakt@dropbox.com','NHS'),
...
('S8QNNAT9','Hillyer','Waye','CT16 8NB','956 Fulton Way','582 497 2018','hwaye8@psu.edu','NHS'),
...
('3353148299','2023-07-09',11,13,'Shoulder (girdle) dystocia  unspecified as to episode of care or not applicable','02793','9947','FZJXKBND'),
...
('5244237101','2023-03-09',11,21,'Pneumonia due to other specified bacteria','02793','7873','12B89XAT'),
...
('639298672','2023-04-03',11,89,'Cortex (cerebral) laceration with open intracranial wound  with moderate [1-24 hours] loss of consciousness','02261','7697','FVEJKSZQ'),
...
('866920552','2023-07-03',17,32,'Primary tuberculous infection  unspecified  tubercle bacilli not found by bacteriological or histological examination  but tuberculosis confirmed by other methods [inoculation of animals]','02261','3802','12B89XAT'),
...
('9213587716','2023-04-01',16,68,'Other specified diseases of pancreas','09652','3573','H77VBDW3'),
...
CREATE TABLE `visit` (
  ...
  `diagnosisID` varchar(12) DEFAULT NULL,
...
('30087241','5701','2023-02-02','Suffers from headache, no root of cause found.','2245'),
...
('9018414','1724','2025-03-15','Sickness morning','P134FD'),
...
-- Dump completed on 2025-03-16 12:42:27
